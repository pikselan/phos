                        ...
                        <div class="price-box-inner">
                            ...
                            <div class="text-center">
                                <div class="btn-group">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-default btn-delete" onclick="deleteItem('Membership/deletePlanPost','<?= $plan->id; ?>','<?= trans("confirm_delete", true); ?>');"><i class="fa fa-trash-o"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
