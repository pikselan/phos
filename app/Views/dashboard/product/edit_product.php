                                    ...
                                    <div id="collapse_<?= $language->id; ?>" class="panel-collapse collapse <?= selectedLangId() == $language->id ? 'in' : ''; ?>">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group m-b-15">
                                                ...
                                                <input type="text" name="keywords_<?= $language->id; ?>" value="<?= !empty($productDetails) ? esc($productDetails->keywords) : ''; ?>" class="form-control form-input" placeholder="<?= trans("keywords"); ?>" maxlength="499">
                                            </div>
                                            <div class="form-group">
