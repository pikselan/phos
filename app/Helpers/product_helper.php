    ...
    function getProductFormData($product)
    {
        ...
        if (!empty($product)) {
            ...
            if ($product->listing_type == 'sell_on_site' || $product->listing_type == 'license_key') {
                ...
                $data->button = '<button class="btn btn-md btn-block btn-product-cart"' . $disabled . '><span class="btn-cart-icon"><i class="icon-tag"></i></span>' . trans("request_a_quote") . '</button>';
                if (!authCheck() && $product->listing_type == 'bidding') {
                    $data->button = '<button type="button" data-toggle="modal" data-target="#loginModal" class="btn btn-md btn-block btn-product-cart"' . $disabled . '><span class="btn-cart-icon"><i class="icon-tag"></i></span>' . trans("request_a_quote") . '</button>';
                }
            } else {
                if (authCheck()) {
